...
import asset20 from "@/assets/images/20.png";
import asset21 from "@/assets/images/21.png";
// Sample post dat
const postData = {
  user: {
    name: "Zingko Kudobum",
...
const SecondndPostFeed = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto  p-4 rounded-lg shadow-lg">
      {/* Header - User Info */}
...
export default SecondndPostFeed;
